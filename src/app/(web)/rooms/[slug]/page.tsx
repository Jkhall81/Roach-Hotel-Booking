            ...
            <div>
              ...
              <div className="flex my-11">
                {room.offeredAmenities.map((amenity) => (
                  ...
                  >
                    <i className={`fa-solid ${amenity.icon} md:text-4xl`}></i>
                ...
                <div className="grid gri-cols-2">
                  {room.offeredAmenities.map((amenity) => (
                    ...
                    >
                      ...
                      <p className="ml-3 text-xs md:text-base pt-3">
                        {amenity.amenity}
                      </p>
                    </div>
                  ))}
              ...
              <div className="mb-11">
                <h2 className="font-bold text-3xl mb-2">What We Are Lacking</h2>
                <div className="grid grid-cols-2">
                  ...
                  <div className="flex items-center my-1 md:my-2">
                    ...
                    <p className="ml-2 md:text-base text-xs">
                      Disinfectant and Sterialization Agents
                    </p>
                  </div>
                  <div className="flex items-center my-1 md:my-2">
                    <GiSmokeBomb />
