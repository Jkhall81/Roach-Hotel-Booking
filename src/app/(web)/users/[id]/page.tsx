...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  return (
    <div className="container h-screen mx-auto px-2 md:px-4 py-10">
      <div className="grid md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <p className="text-xs py-2">
            Joined on {userData._createdAt.split("T")[0]}
          </p>
          ...
          <nav className="text-2xl sticky top-0 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
            <ol
              className={`${
            ...
            >
              ...
              >
                ...
                <a className="inline-flex items-center ms-1 md:mx-3 text-xs md:text-sm font-medium">
                  Curent Bookings
                </a>
              </li>
            </ol>
